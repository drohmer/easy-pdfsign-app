  ...
  if (!pdfData) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 relative">
        ...
        {SITE_URL && <p className="mb-6 sm:mb-8 text-xs text-center"><a href={SITE_URL} className="text-gray-500 hover:text-blue-600 hover:border-blue-400 transition-colors border border-gray-300 rounded-full px-4 py-1.5" style={{textDecoration:'none'}}>scholartools.fr</a></p>}
